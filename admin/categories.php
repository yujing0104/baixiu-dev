...
//如果修改操作和查询操作在一起，一定是先做修改，再查询
//if($_SERVER['REQUEST_METHOD']==='POST'){
  //一旦表单提交请求并且没有通过URL提交ID就意味着是要添加数据
      ...
      <div class="row">
        <div class="col-md-4">
          ...
          <form action="<?php echo $_SERVER['PHP_SELF']; ?>?id=<?php echo $current_edit_category['id']; ?>" method='post'>
            ...
            <div class="form-group">
              ...
              分类名称" value="<?php echo $current_edit_category['name'];?>">
            </div>
            <div class="form-group">
        ...
        <div class="col-md-8">
          <div class="page-action">
            ...
            <a id="btn_delete" class="btn btn-danger btn-sm" href="/baixiu-dev/admin/category-delete.php" style="display: none">批量删除</a>
          </div>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="text-center">
                  <a href="/baixiu-dev/admin/categories.php?id=<?php echo $item['id']; ?>" class="btn btn-info btn-xs">编辑</a>
                  <a href="/baixiu-dev/admin/category-delete.php?id=<?php echo $item['id']; ?>" class="btn btn-danger btn-xs">删除</a>
                </td>
              </tr>
            <?php endforeach ?>
            </tbody>
